# Generated by Powerlevel10k configuration wizard on 2026-06-22 at 14:33 CST.
...
# vertical separators, flat heads, flat tails, 2 lines, dotted, no frame,
...
() {
  ...
  #     '*'           DEFAULT)
  #
  # If your current Google application credentials is "service_account deathray-testing example-user",
