    ...
    text = render_summary_markdown(
        ...
        evidence_groups={
            "evg_a": EvidenceGroup(
                "evg_a",
                "work",
                ("10_Periodic/Daily/2026-07-10.md", "commit:repo:abc123"),
                ("daily_note", "git_commit"),
                {},
            ),
            "evg_b": EvidenceGroup(
                "evg_b",
                "insight",
                ("40_Knowledge/ADR/summary-engine.md",),
                ("adr",),
                {},
            ),
        },
...
def test_weekly_renderer_uses_review_sections_and_wikilinks():
    document = SummaryDocument.from_dict(
        {"contract_version":"summary-v1","taxonomy_version":"dimensions-v1","policy_version":"summary-policy-v1","level":"weekly","period":"2026-W28","headline":"复盘","items":[{"item_type":"decision","title":"取舍","conclusion":"以 evidence 为先","value":"降低漂移","trend":"跨日重复问题持续下降。","dimensions":["计划组织"],"evidence_group_ids":["evg_a"],"confidence":0.9,"supporting_item_ids":["item_a","item_b"],"lower_summary_refs":["70_Summaries/Daily/2026-07-10.md"]}]}
    )
